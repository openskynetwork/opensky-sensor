...
START_TEST(test_decode_modesshort)
{
	uint8_t frm[46];
	struct TEST_Buffer buf = { .payload = frm };
	size_t len = INPUT_buildFrame(frm, ADSB_FRAME_TYPE_MODE_S_SHORT, UINT64_C(0xcafebabedead), 127,
		"abcdefg", 7);
	buf.length = len;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_decode_modeslong)
{
	uint8_t frm[46];
	struct TEST_Buffer buf = { .payload = frm };
	size_t len = INPUT_buildFrame(frm, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xdeadbeefbabe), 0,
		"abcdefghijklmn", 14);
	buf.length = len;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_decode_status)
{
	uint8_t frm[46];
	struct TEST_Buffer buf = { .payload = frm };
	size_t len = INPUT_buildFrame(frm, ADSB_FRAME_TYPE_STATUS, UINT64_C(0xdeadbeefbabe), 0,
		"abcdefghijklmn", 14);
	buf.length = len;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_decode_unknown_next)
{
	...
	size_t len2 = INPUT_buildFrame(frm + len1, ADSB_FRAME_TYPE_MODE_AC, UINT64_C(0x1234567890ab), 0,
		"ab", 2);
...
START_TEST(test_decode_unsynchronized_start)
{
	uint8_t frm[48] = { 'a', 'b' };
	struct TEST_Buffer buf = { .payload = frm };
	size_t len = INPUT_buildFrame(frm + 2, ADSB_FRAME_TYPE_MODE_AC, UINT64_C(0x1234567890ab), -50,
		"ab", 2);
	buf.length = len + 2;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_decode_unsynchronized_type)
{
	...
	len = INPUT_buildFrame(frm + len, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead), -128,
		"abcdefghijklmn", 14);
	buf.length = len + 5;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_decode_unsynchronized_header)
{
	...
	size_t len = INPUT_buildFrame(frm, ADSB_FRAME_TYPE_MODE_AC, UINT64_C(0x1234567890ab), -50,
		"ab", 2);
	len = INPUT_buildFrame(frm + 4, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead), -128,
		"abcdefghijklmn", 14);
	buf.length = len + 4;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_decode_unsynchronized_payload)
{
	...
	size_t len = INPUT_buildFrame(frm, ADSB_FRAME_TYPE_MODE_AC, UINT64_C(0x1234567890ab), -50,
		"ab", 2);
	len = INPUT_buildFrame(frm + 9, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead), -128,
		"abcdefghijklmn", 14);
	buf.length = len + 9;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_buffer_two_frames)
{
	uint8_t frm[46 * 2];
	struct TEST_Buffer buf = { .payload = frm };
	size_t len1 = INPUT_buildFrame(frm, ADSB_FRAME_TYPE_MODE_AC, UINT64_C(0x1234567890ab), -50,
		"ab", 2);
	size_t len2 = INPUT_buildFrame(frm + len1, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead),
...
START_TEST(test_buffer_end_start)
{
	...
	size_t len1 = INPUT_buildFrame(frm, ADSB_FRAME_TYPE_MODE_AC, UINT64_C(0x1234567890ab), -50, "ab",
		2);
	size_t len2 = INPUT_buildFrame(frm2, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead), 26,
		"abcdefghijklmn", 14);
	buf[0].length = len1;
	buf[1].length = len2;
	test.buffers = buf;
...
START_TEST(test_synchronize_peek_unsync)
{
	...
	frm[2] = '\x1a';
	frm[3] = 'b';
	size_t len = INPUT_buildFrame(frm + 4, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead), -128,
		"abcdefghijklmn", 14);
	buf.length = len + 4;
	test.buffers = &buf;
	test.nBuffers = 1;
...
START_TEST(test_synchronize_peek_unsync_at_end)
{
	...
	frm[0] = 'a';
	frm[1] = '\x1a';
	size_t len = INPUT_buildFrame(frm2 + 1, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead), -128,
		"abcdefghijklmn", 14);
	frm2[0] = '\x1a';
...
START_TEST(test_synchronize_peek_sync_at_end)
{
	...
	frm[0] = 'a';
	frm[1] = '\x1a';
	size_t len = INPUT_buildFrame(frm2, ADSB_FRAME_TYPE_MODE_S_LONG, UINT64_C(0xcafebabedead), -128,
		"abcdefghijklmn", 14);
	buf[0].length = sizeof frm;
	buf[1].length = len - 1;
	test.buffers = buf;
